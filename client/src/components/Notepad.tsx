    ...
    >
      ...
      >
        ...
        <div className="pt-12 pb-4 px-8 sm:px-16 flex flex-col gap-1 relative z-10">
          ...
          <input
            className="w-full bg-transparent border-none text-4xl sm:text-5xl font-hand text-slate-800 placeholder:text-slate-300 focus:outline-none focus:ring-0 p-0 mt-4 leading-tight"
